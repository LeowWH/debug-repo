...
@interface MOLPayViewController () <MOLPayLibDelegate>
{
    MOLPayLib *mp;
    BOOL isCloseButtonClick;
    BOOL isPaymentInstructionPresent;
    BOOL isStartedMOLPay;
    NSMutableDictionary *paymentResult;
}
@end
...
//    paymentResult = result;
    paymentResult = [result mutableCopy];
    NSLog(@"transactionResult result = %@", paymentResult);
